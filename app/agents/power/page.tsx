...
function PowerAgentInner() {
  const [reportData, setReportData] = useState({
    powerGeneration: 2450,
    consumptionEfficiency: 87,
    outages: 3,
    renewableEnergy: 42,
    gridStability: 96,
    alerts: [
      { id: 1, message: "Scheduled maintenance in Ward 5 tomorrow", time: "4:10 PM", severity: "medium" },
      { id: 2, message: "Power generation at 98% capacity", time: "2:30 PM", severity: "low" },
      { id: 3, message: "Renewable energy contribution increased", time: "11:45 AM", severity: "low" }
    ],
    recommendations: [
      "Schedule maintenance during low consumption hours",
      "Optimize renewable energy distribution",
      "Review grid stability metrics for improvement"
    ]
  })
  ...
  const generateReportData = (): ReportData => {
    return {
      ...
      metrics: {
        "Power Generation": `${reportData.powerGeneration} MW`,
        "Consumption Efficiency": `${reportData.consumptionEfficiency}%`,
        "Outages": reportData.outages.toString(),
        "Renewable Energy": `${reportData.renewableEnergy}%`,
        "Grid Stability": `${reportData.gridStability}%`
      },
      alerts: reportData.alerts,
      recommendations: reportData.recommendations,
      summary: "The Power Agent is managing 2,450 MW power generation with 87% consumption efficiency. There are 3 active outages, 42% renewable energy contribution, and 96% grid stability."
    }
  }
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/30 dark:to-yellow-800/30 border-yellow-200 dark:border-yellow-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{reportData.powerGeneration} MW</div>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 border-green-200 dark:border-green-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{reportData.consumptionEfficiency}%</div>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{reportData.renewableEnergy}%</div>
              <p className="text-xs text-muted-foreground">Energy mix</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 border-purple-200 dark:border-purple-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{reportData.gridStability}%</div>
              <p className="text-xs text-muted-foreground">Grid health</p>
            </CardContent>
          </Card>
        </div>
