  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-6 md:py-8 grid gap-6 soft-tricolor-bg" role="main">
      ...
      <div className="bg-card border rounded-xl p-6">
        <h1 className="text-2xl font-bold mb-2">Citizen Voice Access</h1>
        <p className="text-muted-foreground mb-6">Speak in your language and get instant assistance</p>
        
        <VoiceConsole />
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <nav aria-label="Citizen quick actions" className="grid grid-cols-1 gap-3">
        ...
        <div className="bg-card border rounded-lg p-4">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            Understand how our AI makes decisions with full explainability
          </p>
          <Link href="/ai-response-demo">
            <Button size="sm" className="w-full">
              View AI Explanation Demo
            </Button>
          </Link>
        </div>
      </div>
